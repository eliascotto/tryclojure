...
var G__53758 = o;
reagent.impl.template.goog$module$goog$object.set(G__53758,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__54143__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54143 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54144__i = 0, G__54144__a = new Array(arguments.length -  0);
while (G__54144__i < G__54144__a.length) {G__54144__a[G__54144__i] = arguments[G__54144__i + 0]; ++G__54144__i;}
  args = new cljs.core.IndexedSeq(G__54144__a,0,null);
} 
return G__54143__delegate.call(this,args);};
G__54143.cljs$lang$maxFixedArity = 0;
G__54143.cljs$lang$applyTo = (function (arglist__54146){
var args = cljs.core.seq(arglist__54146);
return G__54143__delegate(args);
});
...
var G__53799 = o;
reagent.impl.template.goog$module$goog$object.set(G__53799,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__54152__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54152 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54153__i = 0, G__54153__a = new Array(arguments.length -  0);
while (G__54153__i < G__54153__a.length) {G__54153__a[G__54153__i] = arguments[G__54153__i + 0]; ++G__54153__i;}
  args = new cljs.core.IndexedSeq(G__54153__a,0,null);
} 
return G__54152__delegate.call(this,args);};
G__54152.cljs$lang$maxFixedArity = 0;
G__54152.cljs$lang$applyTo = (function (arglist__54155){
var args = cljs.core.seq(arglist__54155);
return G__54152__delegate(args);
});
...
var G__53833 = props;
var G__53833__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53833,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__53833);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53833__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__53841 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53841,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__53841;
}
})(),id_class);
...
var G__53847 = (cljs.core.count(argv) - first_child);
switch (G__53847) {
case (0):
...
var vec__53857 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53857,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53857,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53857,(2),null);
...
var temp__5757__auto___54174 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___54174 == null)){
} else {
var key_54175 = temp__5757__auto___54174;
(jsprops.key = key_54175);
}
...
var temp__5757__auto___54176 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___54176 == null)){
} else {
var key_54178 = temp__5757__auto___54176;
(jsprops.key = key_54178);
}
...
var temp__5757__auto___54184 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___54184 == null)){
} else {
var key_54185 = temp__5757__auto___54184;
(jsprops.key = key_54185);
}
...
var temp__5757__auto___54200 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___54200 == null)){
} else {
var key_54201 = temp__5757__auto___54200;
(jsprops.key = key_54201);
}
...
var temp__5757__auto___54202 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___54202 == null)){
} else {
var key_54203 = temp__5757__auto___54202;
(jsprops.key = key_54203);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53917_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__53917_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__53937 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53937,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53937,(1),null);
...
break;
default:
var G__54210 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__54211 = compiler;
v = G__54210;
compiler = G__54211;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template54031 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template54031 = (function (opts,id,fn_to_element,parse_fn,meta54032){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template54031.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_54033,meta54032__$1){
var self__ = this;
var _54033__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template54031(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta54032__$1));
}));

(reagent.impl.template.t_reagent$impl$template54031.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_54033){
var self__ = this;
var _54033__$1 = this;
return self__.meta54032;
}));

(reagent.impl.template.t_reagent$impl$template54031.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template54031.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template54031.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template54031.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template54031.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template54031.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta54032","meta54032",1852528866,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template54031.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template54031.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template54031");

(reagent.impl.template.t_reagent$impl$template54031.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template54031");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template54031.
 */
reagent.impl.template.__GT_t_reagent$impl$template54031 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template54031(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta54032){
return (new reagent.impl.template.t_reagent$impl$template54031(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta54032));
});

}

return (new reagent.impl.template.t_reagent$impl$template54031(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
