...
var i_46760 = (0);
while(true){
if((i_46760 < arr.length)){
(arr[i_46760] = null);

var G__46761 = (i_46760 + (1));
i_46760 = G__46761;
continue;
} else {
}
...
var i_46775 = (self__.level + (1));
while(true){
if((i_46775 <= (new_level + (1)))){
(update[i_46775] = self__.header);

var G__46778 = (i_46775 + (1));
i_46775 = G__46778;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_46779 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_46779[i]));
} else {
x__$2.forward.push((((i < links_46779.length))?(links_46779[i]):null));
}

if((i < links_46779.length)){
(links_46779[i] = x__$2);
} else {
links_46779.push(x__$2);
}
...
var i_46789 = (0);
while(true){
if((i_46789 <= self__.level)){
var links_46790 = (update[i_46789]).forward;
if((x__$1 === (((i_46789 < links_46790.length))?(links_46790[i_46789]):null))){
(links_46790[i_46789] = (x__$1.forward[i_46789]));

var G__46791 = (i_46789 + (1));
i_46789 = G__46791;
continue;
} else {
var G__46792 = (i_46789 + (1));
i_46789 = G__46792;
continue;
}
} else {
...
var G__46801 = nx;
var G__46802 = (level__$1 - (1));
x = G__46801;
level__$1 = G__46802;
continue;
} else {
var G__46803 = x;
var G__46804 = (level__$1 - (1));
x = G__46803;
level__$1 = G__46804;
continue;
}
