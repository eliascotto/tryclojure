...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_46714 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_46714(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_46717 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_46717(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_46719 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_46719(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_46723 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_46723(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_46728 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_46728(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_46730 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_46730(reader);
}
});
...
var G__46796 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__46797 = s.append(c);
c = G__46796;
s = G__46797;
continue;
}
